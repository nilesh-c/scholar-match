...
object SchemaTableCreator {
  def main(args: Array[String]): Unit = {
    val db = Database.forURL("jdbc:sqlite:/Users/nilesh/Documents/UoB/code/scholar-match/data/sm.db", driver = "org.sqlite.JDBC")
    ...
    codegen.writeToFile(
      "scala.slick.driver.SQLiteDriver", "sm", "sm.db", "Tables", "Tables.scala"
    )
  }
}
